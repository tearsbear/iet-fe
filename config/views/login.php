    ...
    <div class="row full-height">
        ...
        <div class="col-6">
            ...
            <div class="login-form">
                <a href="index.php" class="font-inter-light back-btn">
                    < Back to Home</a>
                        ...
                        <form>
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="font-inter-semi color1">Email*</label>
                            ...
                            <div class="form-group mt-4">
                                <label for="exampleInputPassword1" class="font-inter-semi color1">Password*</label>
                                <input name="password" type="password"
                                    class="form-control font-inter-regular shadow-none" placeholder="input password"
                            ...
                            <div class="footer">
                                ...
                                <a href="#" class="font-inter-light">Forgot Password?</a>
                            </div>
                            ...
                            <p class="font-inter-light mt-4">
                                Don't have an account? <a href="#" class="color1 font-inter-medium">Register</a>
                            </p>
                        </form>
            </div>
        </div>
